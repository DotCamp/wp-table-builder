	...
	private static function get_rating_star($size, $val, $color) {
		...
		>
		  ...
		  <span class="wptb-filled-rating-star">
			...
			>
			  <polygon
			    points="426.667,165.12 273.28,152.107 213.333,10.667 153.387,152.107 0,165.12 116.48,266.027 81.493,416 213.333,336.427 345.173,416 310.187,266.027 "
			  ></polygon>
			</svg>
		  </span>
		  ...
		  <span class="wptb-half-filled-rating-star">
		    ...
		    >
		      <path
		        d="M426.667,165.12L273.28,151.893L213.333,10.667l-59.947,141.44L0,165.12l116.48,100.907L81.493,416l131.84-79.573L345.173,416L310.4,266.027L426.667,165.12z M213.333,296.533v-198.4l36.48,86.187l93.44,8.107l-70.827,61.44l21.333,91.307L213.333,296.533z"
		      ></path>
		    </svg>
		  </span>
		  <span class="wptb-rating-star-right-signal-part"></span>
