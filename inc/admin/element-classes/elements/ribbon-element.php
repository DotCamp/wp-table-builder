        ...
        >
          <div id="wptbRibbonMainWrap" class="wptb-element-ribbon-wrapper" style="">
            <div
              ...
              class="wptb-element-ribbon-inner wptb-ribbon-type-rectangle-text-wrap wptb-plugin-box-shadow-md"
            ...
            <div
              ...
              style="display: none"
              data-wptb-ribbon-icon-animation-type="beat"
              data-wptb-ribbon-icon-src="star"
            >
    ...
    private static function render_bookmark($data)
    {
        ...
        >
          <div
            ...
            class="wptb-element-ribbon-wrapper wptb-ribbon-bookmark-main-wrap wptb-plugin-filter-box-shadow-md"
    ...
    private static function render_corner($data)
    {
        ...
        return <<<HTML
          ...
          >
            <div
              id="wptbRibbonMainWrap"
              class="wptb-element-ribbon-wrapper wptb-ribbon-corner-main-wrap"
              style=""
            >
              <div
                id="wptbRibbonTextWrap"
        ...
        return <<<HTML
          ...
          >
            ...
            >
              <div
                id="wptbRibbonTextWrap"
                class="wptb-element-ribbon-inner wptb-ribbon-icon01-text-wrap wptb-plugin-filter-box-shadow-md"
                style=""
              >
                <p
                  style="width: auto;font-size: {$fontSize};position: relative;background-color: {$bgColor};"
                  class="wptb-element-ribbon-text"
                >
                  {$text}
                </p>
                <div
                  class="wptb-ribbon-icon01-triangle-end"
                  style="border-right: 20px solid transparent;border-bottom: 88px solid {$bgColor};"
                ></div>
              </div>
              <div
                class="wptb-element-ribbon-color-dump"
                style="background-color: {$bgColor}; border-color: rgb(0, 0, 0)"
              ></div>
              <div
                id="wptbRibbonIconDump"
                style="display: block; background-color: {$bgColor}"
                class="wptb-plugin-filter-box-shadow-md wptb-ribbon-icon01-icon-wrapper"
                data-wptb-ribbon-icon-src="{$icSrc}"
                {$icAttrs}
              >
                {$icon}
              </div>
        ...
        return <<<HTML
          ...
          >
            ...
            >
              <div
                id="wptbRibbonTextWrap"
                class="wptb-element-ribbon-inner wptb-ribbon-sideFancy-text-wrap wptb-plugin-filter-box-shadow-md"
                style="background-color: {$bgColor}; border-color: {$borderColor}"
              >
                <p
                  style="width: auto; font-size: 15px; position: relative"
                  class="wptb-element-ribbon-text"
                >
                  {$text}
                </p>
              ...
              <div class="wptb-ribbon-side-fancy-triangle-wrapper">
                <div
                  ...
                  style="border-right: 20px solid transparent;border-bottom: 20px solid {$bgColor};"
                ></div>
                <div
                  class="wptb-ribbon-side-fancy-triangle-overlay"
                  style="border-right: 20px solid transparent;border-bottom: 20px solid rgba(0, 0, 0, 0.4);"
                ></div>
              </div>
            </div>
          </div>
