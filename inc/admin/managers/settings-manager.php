...
class Settings_Manager
{
	...
	public $sanitization_rules = [
		...
		'use_legacy_builder' => 'sanitize_text_field',
	];
	...
	public function __construct($options_root, $loader)
	{
		...
		$loader->add_action('wp_ajax_wptb_toggle_legacy_builder', $this, 'wptb_toggle_legacy_builder');
	...
	public function wptb_toggle_legacy_builder()
	{
		$data = [];
	...
	{
		$this->settings_menu_slug = add_submenu_page(
			'wptb-overview',
