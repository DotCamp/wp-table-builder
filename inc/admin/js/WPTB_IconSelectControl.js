...
var _default = {
  ...
  methods: {
    handleScroll: function handleScroll() {
      ...
      var relativeHeight = this.relativeElement.offsetHeight;
...
},{}],"containers/IconSelectControl.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.targetElement = document.querySelector(".".concat(this.targetClass));
    var buttonIcon = this.targetElement.querySelector('.wptb-button-icon');
    var selectedIcon = buttonIcon.dataset.wptbButtonIconSrc;
  ...
  watch: {
    ...
    selectedIcon: {
      handler: function handler() {
        ...
        var targetObj = this.targetElement.querySelector('.wptb-button-icon');
        ...
        if (targetObj) {
          if (this.selectedIcon.url) {
            fetch(this.selectedIcon.url).then(function (r) {
              ...
              targetObj.dataset.wptbButtonIconSrc = _this3.selectedIcon.name;
              targetObj.innerHTML = '';
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  [_c("div", { staticClass: "wptb-icon-select-drawer-end" })]
                )
              ],
              1
            )
...
},{"../components/IntersectionObserver":"components/IntersectionObserver.vue"}],"WPTB_IconSelectControl.js":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/WPTB_IconSelectControl.js.map