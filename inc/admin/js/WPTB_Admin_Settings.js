...
},{"vue":"../../../../../node_modules/vue/dist/vue.esm.js"}],"../../../../../node_modules/@babel/runtime/helpers/arrayWithHoles.js":[function(require,module,exports) {
...
var store = _objectSpread({}, wptbAdminSettingsData.options);

var rawStore = _objectSpread({}, wptbAdminSettingsData.options);
/**
...
exports.default = _default;
},{"@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js"}],"mixins/withMessage.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js"}],"components/MenuHeader.vue":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js","./SectionItem":"components/SectionItem.vue","./ActiveSectionIndicator":"components/ActiveSectionIndicator.vue"}],"components/BusyRotate.vue":[function(require,module,exports) {
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "wptb-setting-control" },
    [
      _vm.title
...
render._withStripped = true
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("portal", { attrs: { to: "footerButtons" } }, [
    _c(
      "div",
      { staticClass: "wptb-settings-button-container" },
      [_vm._t("default")],
...
},{}],"containers/GeneralSettings.vue":[function(require,module,exports) {
"use strict";
...
var _SettingCard = _interopRequireDefault(require("../components/SettingCard"));
...
exports.default = _default;
  ...
  return _c(
    ...
    [
      _c(
        "menu-content",
        _vm._l(_vm.currentFields, function(field) {
          return _c(
            "setting-card",
            { key: field.id, attrs: { title: field.label } },
            [
              _c("control-item", {
                attrs: { "field-data": field, modelBind: _vm.store }
              })
            ],
            1
          )
        ...
        [
          ...
          _c(
            "menu-button",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.$emit("submitSettings")
                }
              }
            },
...
},{"vue-fragment":"../../../../../node_modules/vue-fragment/dist/vue-fragment.esm.js","../components/SettingCard":"components/SettingCard.vue","../components/ControlItem":"components/ControlItem.vue","../components/MenuContent":"components/MenuContent.vue","../components/MenuButton":"components/MenuButton.vue","../components/Settings/FooterButtons":"components/Settings/FooterButtons.vue"}],"components/VersionControlRow.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
  ...
  return _c("fragment", [
    _c(
      ...
      {
        staticClass:
          "wptb-version-control-row-element wptb-version-control-row-label"
      },
    ...
    _c(
      ...
      {
        staticClass:
          "wptb-version-control-row-element wptb-version-control-row-slot"
      },
      [_vm._t("default")],
      2
    )
...
},{"vue-fragment":"../../../../../node_modules/vue-fragment/dist/vue-fragment.esm.js"}],"components/VersionIndicator.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "wptb-version-indicator" }, [
    _c("div", {
      staticClass: "wptb-version-indicator-circle",
      class: _vm.indicatorStyle
    }),
    _vm._v(" "),
    _c("div", { staticClass: "wptb-version-indicator-version" }, [
...
},{}],"components/Changelog.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    var versionWrappers = Array.from(wrapper.querySelectorAll('h4'));
    var changelogWrappers = Array.from(wrapper.querySelectorAll('ul')); // eslint-disable-next-line array-callback-return

    versionWrappers.map(function (v, i) {
      var version = v.textContent;
      _this.parsedChangelog[version] = changelogWrappers[i] !== undefined ? changelogWrappers[i].outerHTML : '';
    });
  },
  computed: {
    getVersionChangelog: function getVersionChangelog() {
      if (this.parsedChangelog[this.version]) {
        return this.prepareHeader(this.version) + this.parsedChangelog[this.version];
      }

      return this.prepareHeader("no changelog found for version".concat(this.version));
    }
  },
  methods: {
    prepareHeader: function prepareHeader(htmlContent) {
      return "<h4 style=\"text-align: center;\">".concat(htmlContent, "</h4>");
    }
  }
};
exports.default = _default;
  ...
  var _c = _vm._self._c || _h
  return _c("div", {
    staticClass: "wptb-version-control-changelog wptb-unselectable",
    domProps: { innerHTML: _vm._s(_vm.getVersionChangelog) }
  })
}
var staticRenderFns = []
render._withStripped = true
...
},{}],"mixins/SettingsMenuSection.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"components/VersionControlSettings.vue":[function(require,module,exports) {
"use strict";
...
var _VersionControlRow = _interopRequireDefault(require("./VersionControlRow"));

var _VersionIndicator = _interopRequireDefault(require("./VersionIndicator"));
...
var _default = {
  components: {
    FooterButtons: _FooterButtons.default,
    VersionControlRow: _VersionControlRow.default,
    MenuContent: _MenuContent.default,
    Fragment: _vueFragment.Fragment,
    MenuButton: _MenuButton.default,
  ...
  mixins: [_withMessage.default, _SettingsMenuSection.default],
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    var currentVersion = this.sectionData.currentVersion;
  ...
  computed: {
    ...
    sortedVersions: function sortedVersions() {
      return Object.keys(this.allVersions).sort(function (a, b) {
        if (a > b) {
          return -1;
        }
  ...
  methods: {
    isVersionSelected: function isVersionSelected(v) {
      ...
      if (!this.isVersionSelected(this.currentVersion) && !this.isBusy()) {
        ...
        if (window.confirm(this.strings.rollbackConfirmation)) {
          ...
          fetch(ajaxUrl, {
            ...
            if ((0, _typeof2.default)(resp) === 'object') {
              if (resp.error) {
              ...
              [
                ...
                _c("changelog", {
                  attrs: {
                    ...
                    "raw-changelog": _vm.sectionData.changelog
                  }
                })
              ],
              1
          ...
          !_vm.installResult
            ? _c(
                "menu-button",
                {
                  attrs: {
                    disabled:
                      _vm.isVersionSelected(_vm.currentVersion) || _vm.isBusy(),
                    type: "primary"
                  },
...
},{"@babel/runtime/helpers/typeof":"../../../../../node_modules/@babel/runtime/helpers/typeof.js","vue-fragment":"../../../../../node_modules/vue-fragment/dist/vue-fragment.esm.js","./MenuContent":"components/MenuContent.vue","./MenuButton":"components/MenuButton.vue","./VersionControlRow":"components/VersionControlRow.vue","./VersionIndicator":"components/VersionIndicator.vue","./Changelog":"components/Changelog.vue","../mixins/withMessage":"mixins/withMessage.js","./Settings/FooterButtons":"components/Settings/FooterButtons.vue","../mixins/SettingsMenuSection":"mixins/SettingsMenuSection.js"}],"../../../../../node_modules/codemirror/lib/codemirror.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"components/CssCodeInput.vue":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js","codemirror":"../../../../../node_modules/codemirror/lib/codemirror.js","codemirror/lib/codemirror.css":"../../../../../node_modules/codemirror/lib/codemirror.css","codemirror/addon/selection/active-line":"../../../../../node_modules/codemirror/addon/selection/active-line.js","codemirror/mode/css/css":"../../../../../node_modules/codemirror/mode/css/css.js","./EmptyCover":"components/EmptyCover.vue"}],"components/Settings/GeneralStylesSettings.vue":[function(require,module,exports) {
"use strict";
...
var _CssCodeInput = _interopRequireDefault(require("../CssCodeInput"));
...
var _default = {
  ...
  computed: {
    isCodeChanged: function isCodeChanged() {
      return this.code !== this.cachedCode;
    },
    buttonDisabledState: function buttonDisabledState() {
      return !this.isCodeChanged || this.isBusy();
    }
  },
  methods: {
    updateCachedCode: function updateCachedCode() {
      this.cachedCode = this.code;
    },
    resetCodeToCached: function resetCodeToCached() {
      this.code = this.cachedCode;
    },
    sendSavedStyles: function sendSavedStyles() {
      var _this = this;

      // set application to busy state
      this.setBusy(true); // prepare form data that will be sent with REST request
      ...
      fetch(ajaxUrl, {
        ...
        throw new Error("An error occurred while saving CSS code: ".concat(res.statusText));
      }).then(function (resp) {
        if (resp.error) {
          throw new Error("An error occurred while saving CSS code: ".concat(resp.error));
        } else {
          _this.setMessage({
            message: resp.message
          });

          _this.updateCachedCode();
        }
      }).catch(function (err) {
        _this.setMessage({
          type: 'error',
    ...
    [
      _c("menu-content", { attrs: { center: true } }, [
        _c("div", { staticClass: "wptb-general-style-settings" }, [
          ...
          _c(
            "div",
            { staticClass: "wptb-general-css-code-input" },
            [
              _c("css-code-input", {
                attrs: { disabled: _vm.isBusy() },
                scopedSlots: _vm._u([
      ...
      _c(
        ...
        [
          ...
          _c(
            "menu-button",
            {
              attrs: { disabled: _vm.buttonDisabledState },
              on: { click: _vm.sendSavedStyles }
            },
            [_vm._v(_vm._s(_vm.strings.submit))]
          )
        ],
...
},{"vue-fragment":"../../../../../node_modules/vue-fragment/dist/vue-fragment.esm.js","../MenuContent":"components/MenuContent.vue","./FooterButtons":"components/Settings/FooterButtons.vue","../MenuButton":"components/MenuButton.vue","../CssCodeInput":"components/CssCodeInput.vue","../../mixins/SettingsMenuSection":"mixins/SettingsMenuSection.js","../../mixins/withMessage":"mixins/withMessage.js","../BusyRotate":"components/BusyRotate.vue"}],"containers/SettingsApp.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  components: {
    ...
    VersionControlSettings: _VersionControlSettings.default,
    GeneralStylesSettings: _GeneralStylesSettings.default
  },
  mixins: [_withStore.default, _withMessage.default],
  data: function data() {
    return {
      sections: {},
      currentSection: '',
  ...
  beforeMount: function beforeMount() {
    ...
    Object.keys(this.sectionsData).map(function (section) {
      ...
      if (Object.prototype.hasOwnProperty.call(_this.sectionsData, section)) {
        if (_this.parsedFields[section] === undefined) {
          _this.parsedFields[section] = [];
        }

        if (_this.sectionsData[section].fields !== undefined && (0, _typeof2.default)(_this.sectionsData[section].fields) === 'object') {
          // eslint-disable-next-line array-callback-return
    ...
    var _Object$keys$map2 = (0, _slicedToArray2.default)(_Object$keys$map, 1);
  ...
  computed: {
    ...
    currentTemplate: function currentTemplate() {
      return "".concat(this.currentSection[0].toUpperCase() + this.currentSection.slice(1), "Settings");
    }
  },
  methods: {
    resetStore: function resetStore() {
      if (this.canSubmit) {
        ...
        this.setMessage({
          message: this.strings.revertMessage
        });
      }
    },
    submitSettings: function submitSettings() {
      ...
      var formData = new FormData(); // security prep for fetch request
      ...
      this.canSubmit = false;
      this.fetching = true; // fetch request to update plugin options
  ...
  return _c(
    ...
    [
      ...
      _c(_vm.currentTemplate, {
        tag: "component",
        attrs: {
          "current-fields": _vm.currentFields,
          store: _vm.store,
          disabled: !_vm.canSubmit,
          "template-data": _vm.sectionData
        },
        on: { resetStore: _vm.resetStore, submitSettings: _vm.submitSettings }
      }),
      _vm._v(" "),
      _c(
        "menu-footer",
...
},{"@babel/runtime/helpers/slicedToArray":"../../../../../node_modules/@babel/runtime/helpers/slicedToArray.js","@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js","@babel/runtime/helpers/typeof":"../../../../../node_modules/@babel/runtime/helpers/typeof.js","../mixins/withStore.js":"mixins/withStore.js","../mixins/withMessage":"mixins/withMessage.js","../components/MenuHeader.vue":"components/MenuHeader.vue","../components/Sections.vue":"components/Sections.vue","../components/MenuFooter.vue":"components/MenuFooter.vue","../components/MenuButton.vue":"components/MenuButton.vue","./GeneralSettings":"containers/GeneralSettings.vue","../components/VersionControlSettings":"components/VersionControlSettings.vue","../components/Settings/GeneralStylesSettings":"components/Settings/GeneralStylesSettings.vue"}],"plugins/strings.js":[function(require,module,exports) {
"use strict";
...
_vue.default.config.productionTip = false; // strings plugin install
...
new _vue.default({
  components: {
    SettingsApp: _SettingsApp.default
  },
  data: {
...
},{"@babel/runtime/helpers/defineProperty":"../../../../../node_modules/@babel/runtime/helpers/defineProperty.js","vue":"../../../../../node_modules/vue/dist/vue.esm.js","portal-vue":"../../../../../node_modules/portal-vue/dist/portal-vue.common.js","./containers/SettingsApp.vue":"containers/SettingsApp.vue","./plugins/strings.js":"plugins/strings.js"}]},{},["WPTB_Admin_Settings.js"], null)
