...
import DatabaseUpdaterSettings from "$Components/Settings/DatabaseUpdaterSettings";
...
export default {
    ...
    beforeMount() {
        ...
        Object.keys(this.sectionsData).map((section) => {
            ...
            if (
                Object.prototype.hasOwnProperty.call(this.sectionsData, section)
            ) {
                ...
                if (
                    ...
                    // eslint-disable-next-line array-callback-return
                    Object.keys(this.sectionsData[section].fields).map(
                        (field) => {
                            if (
                                Object.prototype.hasOwnProperty.call(
                                    this.sectionsData[section].fields,
                                    field
                                )
                            ) {
                                this.parsedFields[section].push({
                                    ...this.sectionsData[section].fields[field],
                                    id: field,
                                });
                            }
                        }
    ...
    computed: {
        ...
        currentTemplate() {
            return `${
                this.currentSection[0].toUpperCase() +
