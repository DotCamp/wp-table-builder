...
},{}],"../../../../../node_modules/vue-color/dist/vue-color.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this.innerColor.hex8 = _this.color; // event listeners to hide opened color picker on certain DOM events
  ...
  computed: {
    toolVisibility: function toolVisibility() {
      return {
        visibility: this.visibility ? 'visible' : 'hidden'
      };
    },
    colorPickerStyle: function colorPickerStyle() {
      return {
        backgroundColor: this.innerColor.hex8
      };
    },
    keepToolInsideWindow: function keepToolInsideWindow() {
      if (this.visibility && this.$refs.inputWrapper) {
        ...
        var _this$$refs$tool$getB = this.$refs.tool.getBoundingClientRect(),
            toolWidth = _this$$refs$tool$getB.width,
  ...
  methods: {
    ...
    handleHide: function handleHide(event) {
      var allowedDefaultEvents = ['wheel', 'click']; // handle keyup event if it is the current type
...
},{"vue-color":"../../../../../node_modules/vue-color/dist/vue-color.min.js"}],"containers/DifferentBorderControl.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"vue":"../../../../../node_modules/vue/dist/vue.esm.js","../functions/WPTB_ControlsManager":"functions/WPTB_ControlsManager.js","../containers/NotificationManagerDevTool":"containers/NotificationManagerDevTool.vue"}],"components/leftPanel/SectionGroupCollapse.vue":[function(require,module,exports) {
"use strict";
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      document.addEventListener('wptbSectionChanged', function (_ref) {
        var detail = _ref.detail;
        _this.visibility = detail === 'background_menu';
      });
    });
  }
};
exports.default = _default;
      ...
      if (typeof $48a64f === 'function') {
        $48a64f = $48a64f.options;
      }
    
        /* template */
        Object.assign($48a64f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("transition", { attrs: { name: "wptb-fade" } }, [
    _vm.visibility
      ? _c(
          "div",
          { staticClass: "wptb-background-menu" },
          [
            _c(
...
},{"../components/leftPanel/SectionGroupCollapse":"components/leftPanel/SectionGroupCollapse.vue","../components/ColorPicker":"components/ColorPicker.vue"}],"mountPoints/WPTB_BackgroundMenu.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  name: 'BackgroundMenu',
  handler: function handler(uniqueId) {
    new _vue.default({
      components: {
        TableBackgroundMenu: _TableBackgroundMenu.default
      },
...
exports.default = _default;
},{"vue":"../../../../../node_modules/vue/dist/vue.esm.js","../containers/TableBackgroundMenu":"containers/TableBackgroundMenu.vue"}],"WPTB_BuilderControls.js":[function(require,module,exports) {
...
},{"vue":"../../../../../node_modules/vue/dist/vue.esm.js","./mountPoints/WPTB_IconSelectControl":"mountPoints/WPTB_IconSelectControl.js","./mountPoints/WPTB_RangeControl":"mountPoints/WPTB_RangeControl.js","./mountPoints/WPTB_Select2Control":"mountPoints/WPTB_Select2Control.js","./mountPoints/WPTB_MediaSelectControl":"mountPoints/WPTB_MediaSelectControl.js","./functions/WPTB_ControlsManager":"functions/WPTB_ControlsManager.js","./mountPoints/WPTB_ResponsiveTable":"mountPoints/WPTB_ResponsiveTable.js","./mountPoints/WPTB_SidesControl":"mountPoints/WPTB_SidesControl.js","./mountPoints/WPTB_NamedToggleControl":"mountPoints/WPTB_NamedToggleControl.js","./mountPoints/WPTB_TagControl":"mountPoints/WPTB_TagControl.js","./mountPoints/WPTB_DifferentBorderControl":"mountPoints/WPTB_DifferentBorderControl.js","./mountPoints/WPTB_LocalDevFileControl":"mountPoints/WPTB_LocalDevFileControl.js","./mountPoints/WPTB_NotificationManagerView":"mountPoints/WPTB_NotificationManagerView.js","./mountPoints/WPTB_NotificationManagerDevTool":"mountPoints/WPTB_NotificationManagerDevTool.js","./mountPoints/WPTB_BackgroundMenu":"mountPoints/WPTB_BackgroundMenu.js"}]},{},["WPTB_BuilderControls.js"], null)
