...
var _default = {
  ...
  methods: {
    ...
    handleColorChange: function handleColorChange(colorObj) {
...
exports.default = _default;
},{"vue":"../../../../../node_modules/vue/dist/vue.esm.js","../functions/WPTB_ControlsManager":"functions/WPTB_ControlsManager.js","../containers/NotificationManagerDevTool":"containers/NotificationManagerDevTool.vue"}],"../../../../../node_modules/memize/index.js":[function(require,module,exports) {
/**
    ...
    _c(
      ...
      [
        _c(
          ...
          {
            attrs: {
              label: _vm.translationM("generalRow"),
          ...
          [
            _c("color-picker", {
              attrs: {
                color: _vm.generalOptions("headerBg"),
                label: _vm.translationM("headerBg")
              },
              on: {
                colorChanged: function($event) {
                  return _vm.setGeneralOption({
                    subKey: "headerBg",
                    value: $event
                  })
                }
            ...
            _c("color-picker", {
              attrs: {
                color: _vm.generalOptions("evenBg"),
                label: _vm.translationM("evenRow")
              },
              on: {
                colorChanged: function($event) {
                  return _vm.setGeneralOption({
            ...
            _c("color-picker", {
              attrs: {
                color: _vm.generalOptions("oddBg"),
                label: _vm.translationM("oddRow")
              },
              on: {
                colorChanged: function($event) {
                  return _vm.setGeneralOption({
...
var _default = state;
exports.default = _default;
},{}],"stores/backgroundMenu/getters.js":[function(require,module,exports) {
"use strict";
...
var getters = {
   ...
   */
  generalOptions: function generalOptions(state) {
    return function (key) {
...
var _default = getters;
exports.default = _default;
},{}],"stores/backgroundMenu/mutations.js":[function(require,module,exports) {
"use strict";
