...
<nav class="table management bar" id="edit-bar">
 ...
 <!--   <li>
      <svg width="48" height="36" id="wptb-add-column-after" title="Add column after highlighted one">
    ...
    <li>
      <svg width="48" height="36" id="wptb-add-column-before" title="Add column before highlighted one">
    ...
    <li id="add-row-end2">
      <svg width="48" height="36" id="wptb-add-row-after" title="Add row after highlighted one">
    ...
    <li id="add-row-end3">
      <svg width="48" height="36" id="wptb-add-row-before" title="Add row before highlighted one">
    ...
    <li>
      <svg width="48" height="36" id="wptb-merge-cells" class="multiple-select-action" title="Merge selected Cells">
    ...
    <li>
      <svg width="48" height="36" id="wptb-split-cell" class="single-action" title="Unmerge selected cell">
        <rect x="3" y="3" width="37" height="29" style="fill:#fff;stroke-width:2;stroke:#003;"/>  
        <line x1="21" y1="7" x2="21" y2="32" style="stroke:#000;stroke-width:2" stroke-dasharray="1 2" />
        <line x1="5" y1="17" x2="18" y2="17" style="stroke:#000;stroke-width:2"  />
        <line x1="24" y1="17" x2="37" y2="17" style="stroke:#000;stroke-width:2"  />
