  ...
  <div class="wptb-container">
    ...
    <div class="wptb-builder-panel">
      <div class="wptb-builder-header">
		  ...
		  <?php do_action( 'wp-table-builder/action/builder-header-after' ); ?>
      </div>
      <div
          class="wptb-builder-content"><?php require_once NS\WP_TABLE_BUILDER_DIR . 'inc/admin/views/builder/wptb-builder-table-setup.php'; ?></div>
