	...
	public function column_default( $item, $column_name ) {
		...
		switch ( $column_name ) {
			case 'id':
				return $item->ID;
			case 'shortcode':
				$shortcode = '<div class="main-shortcode-div">
                        <span class="shortcode-' . $item->ID . '">[wptb id=' . $item->ID . ']</span>
                        <div onclick="copyClipboard(' . $item->ID . ')" class="inner-shortcode" id="divSvg">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 115.77 122.88" width="30" height="30" style="enable-background:new 0 0 115.77 122.88" xml:space="preserve"><style type="text/css">.st0 {
                                            fill-rule: evenodd;
                                            clip-rule: evenodd;
                                        }</style>
                                    <g>
                                ...
                                <span class="tooltiptext" style="visibility: hidden;">Copy</span>
                            </div></div>';
